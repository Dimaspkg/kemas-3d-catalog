...
interface EditMaterialCategoryDialogProps {
    category: Category;
    trigger?: React.ReactNode;
}

export function EditMaterialCategoryDialog({ category, trigger }: EditMaterialCategoryDialogProps) {
    ...
    const onSubmit = async (data: CategoryFormValues) => {
        ...
        try {
            const categoryRef = doc(db, "materialCategories", category.id);
